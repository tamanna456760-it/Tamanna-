...
class APMMonitor:
    ...
    def record_metric(self, endpoint: str, response_time: float, success: bool = True):
            ...
            if metrics:
                ...
                report[endpoint] = {
                    "avg_response_time": statistics.mean(
                        m.response_time for m in recent
                    ),
                    "p95_response_time": sorted([m.response_time for m in recent])[
                        int(0.95 * len(recent))
                    ],
