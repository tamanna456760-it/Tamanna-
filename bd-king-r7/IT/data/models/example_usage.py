...
async def example_usage():
    ...
    # Analyze patterns
    pattern_analysis = await cnn_detector.detect_patterns(X_test, confidence_threshold=0.8)
    print(f"High confidence patterns detected: {pattern_analysis['high_confidence_matches']}")
