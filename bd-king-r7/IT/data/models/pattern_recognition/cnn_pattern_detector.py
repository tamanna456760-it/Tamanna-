...
class CNNPatternDetector(BaseNeuralNetwork):
    ...
    def __init__(self, config: Dict = None):
        ...
        self.logger.info(f"🔄 CNN Pattern Detector initialized with input shape {self.input_shape}")
    ...
    async def detect_patterns(self, data: np.ndarray, confidence_threshold: float = 0.8) -> Dict:
        """
