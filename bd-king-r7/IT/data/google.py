...
try:
    ...
    print("Some dependencies missing. Install with: pip install googlesearch-python google-api-python-client gspread google-auth-httplib2 google-auth-oauthlib beautifulsoup4 requests")
...
class GoogleServices:
    ...
    # ===== GOOGLE SEARCH =====
    def search_web(self, query: str, num_results: int = 10, lang: str = 'en') -> List[str]:
        """
    ...
    def search_with_details(self, query: str, num_results: int = 5) -> List[Dict[str, str]]:
        """
    ...
    # ===== GOOGLE SHEETS =====
    def setup_sheets(self, credentials_file: str, sheet_name: str = None, sheet_url: str = None):
        """
        Setup Google Sheets connection
        """
        try:
            scope = ['https://www.googleapis.com/auth/spreadsheets']
            creds = ServiceAccountCredentials.from_service_account_file(credentials_file, scopes=scope)
    ...
    def list_drive_files(self, folder_id: str = None, file_type: str = None) -> List[Dict]:
        """
    ...
    def custom_search(self, query: str, search_engine_id: str, num_results: int = 10) -> List[Dict]:
        """
    ...
    # ===== UTILITY METHODS =====
    def save_results_to_file(self, results: List, filename: str = 'google_results.json'):
        """
