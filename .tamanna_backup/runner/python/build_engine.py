...
class BuildEngine:
    ...
    async def trigger_build(
        self, environment: str, language: str = None, clean: bool = False
    ):
    ...
    async def _run_tests(self, language: str, environment: str):
        ...
        try:
            test_command = self.config["build"]["languages"][language].get(
                "test_command"
            )
            if test_command:
    ...
    async def _send_build_notification(
        self, environment: str, success: bool, message: str = ""
    ):
