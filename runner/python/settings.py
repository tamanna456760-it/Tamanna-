...
SECURITY_CONFIG = {
    ...
    "authentication": {"jwt_expiry_hours": 24, "max_login_attempts": 5},
    "network": {
...
MONITORING_CONFIG = {
    ...
    "alerts": {"email_enabled": True, "sms_enabled": False, "webhook_url": None},
    "metrics": {"retention_days": 7, "collection_interval": 30},
}
