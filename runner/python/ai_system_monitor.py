...
def check_ai_system_health():
    ai_status_url = 'https://example.com/ai/status'  # AI সিস্টেমের স্ট্যাটাস এন্ডপয়েন্ট
        ...
        for file in files:
            if file['type'] == 'file':
                ...
                if file_response.status_code == 200:
                    ...
                    ai_lines = decoded_content.count('AI')  # উদাহরণস্বরূপ, 'AI' লাইনগুলোর সংখ্যা গণনা করছি
                    total_ai_lines += ai_lines
        print(f'Total AI-related lines of code: {total_ai_lines}')
    else:        print(f'Failed to fetch repo data: {response.status_code}')
